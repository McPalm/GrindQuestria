...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        /// <summary>
        /// Treat all neighbor tiles with the same hash as the same tile for tiling purposes.
        /// Zero treats only itself as neighbor
        /// </summary>
        public int NeighborHash = 0;
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            switch (neighbor)
            {
                case TilingRule.Neighbor.This:
                    ...
                    else if(NeighborHash != 0 && other is RuleTile)
                    {
                        return (other == this || (other as RuleTile).NeighborHash == NeighborHash);
                    }
                    return other == this;
